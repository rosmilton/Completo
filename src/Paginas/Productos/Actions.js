...
export const Actions = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/Completo/php/all-productos.php")
      .then((res) => {
        return res.json();
      })
      .then((data) => {
  ...
  const insertUser = (newUser) => {
    fetch("http://localhost/Completo/php/add-producto.php", {
      method: "POST",
      headers: {
  ...
  const updateUser = (userData) => {
    fetch("http://localhost/Completo/php/update-producto.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const deleteUser = (theID) => {
    ...
    fetch("http://localhost/Completo/php/delete-producto.php", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
